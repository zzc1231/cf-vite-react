        ...
        return (
            ...
            >
                {matrix.map((column, x) => (
                    <div
                        key={x}
                        className={`flex-1 flex flex-col gap-0.5 ${x === highlighted ? "bg-gradient-to-t from-orange-600 to-orange-400 shadow-xl  shadow-orange-500/50" : ""
                            }`}
                    >
                        {column.map((filled, y) => (
                            <button
                ...
                ${filled ? "bg-green-600 dark:bg-green-600/50  shadow" : "bg-gray-300 dark:bg-gray-700/50"}
